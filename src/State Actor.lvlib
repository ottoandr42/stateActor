...
<Library LVVersion="24008000">
	...
	<Item Name="Messages" Type="Folder">
		<Item Name="Events" Type="Folder">
			<Item Name="Timeout Msg.lvclass" Type="LVClass" URL="../State Actor Messages/Timeout Msg/Timeout Msg.lvclass"/>
			<Item Name="Delay Complete Msg.lvclass" Type="LVClass" URL="../State Actor Messages/Delay Complete Msg/Delay Complete Msg.lvclass"/>
		</Item>
		<Item Name="Get State Transition User Event Msg.lvclass" Type="LVClass" URL="../State Actor Messages/Get State Transition User Event Msg/Get State Transition User Event Msg.lvclass"/>
	</Item>
