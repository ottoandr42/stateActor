...
<Library LVVersion="24008000">
	...
	<Item Name="Events" Type="Folder">
		<Item Name="Cycle Complete Msg.lvclass" Type="LVClass" URL="../Main Messages/Cycle Complete Msg/Cycle Complete Msg.lvclass"/>
		<Item Name="Cycle Start Msg.lvclass" Type="LVClass" URL="../Main Messages/Cycle Start Msg/Cycle Start Msg.lvclass"/>
		<Item Name="Reset Msg.lvclass" Type="LVClass" URL="../Main Messages/Reset Msg/Reset Msg.lvclass"/>
	</Item>
	<Item Name="States" Type="Folder">
		...
		<Item Name="Start Delay.lvclass" Type="LVClass" URL="../Start Delay/Start Delay.lvclass"/>
